 ...
 * @typedef {import('./types').BlockHeader} BlockHeader
 * @typedef {import('./types').BlockIndex} BlockIndex
 * @typedef {import('./types').BytesReader} BytesReader
 * @typedef {import('./types').CarHeader} CarHeader
 * @typedef {import('./types').CarDecoder} CarDecoder
 */
